...
::* default JVM options
if not defined CQ_JVM_OPTS set CQ_JVM_OPTS=-Xmx4024m -XX:MaxPermSize=256M -Djava.awt.headless=true -Djava.awt.headless=true -Xdebug -Xrunjdwp:transport=dt_socket,server=y,address=30304,suspend=n
