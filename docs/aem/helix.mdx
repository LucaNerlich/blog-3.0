...
<div class="alert alert--info" role="alert">
    As mentioned intially, a Helix Developer works "frontend only". The backend architecture has been summarized well by the development team here: [hlx.live/docs/architecture](https://www.hlx.live/docs/architecture).
</div>ß
